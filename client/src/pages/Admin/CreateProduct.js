    ...
    <div className='container-fluid m-3'>
        ...
        <div className='col-md-9'>
            ...
            <div className='m-1  w-75 '>
              <Select bordered={false} placeholder="select a category" size="large" showSearch className='from-select mb-3 col-md-12' onChange={(value)=>{setCategory(value)}}>
              {categories?.map((c)=>(
            ...
            <div className='mb-3'>
              <input type = "text" value={description} placeholder='Description' className='form-control form-control-lg"' onChange = {(e)=>setDescription(e.target.value)}></input>
            </div>
            <div className='mb-3'>
            ...
            <div className='mb-3'>
              <Select bordered={false} placeholder="Select Shipping" size='large' showSearch className='form-select mb-3' onChange={(e)=>setShipping(e)}>
